...
const initialMessages = [
  {
    id: 1,
    message: "Hi Vatsal! 👋 I'm your MindSpace companion. I'm here to listen, support, and chat whenever you need. How are you feeling today?",
    isUser: false,
    timestamp: '10:00 AM',
  },
];
...
const crisisKeywords = ['suicide', 'kill myself', 'end it all', 'self-harm', 'don\'t want to live'];
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-4rem)]">
      ...
      <div className="flex items-center gap-3 px-5 lg:px-8 py-4">
        ...
        <div>
          <h2 className="text-base font-semibold text-text-primary">MindSpace AI Companion</h2>
          <div className="flex items-center gap-1.5">
            <span className="w-1.5 h-1.5 bg-emerald-400 rounded-full animate-pulse-soft" />
            <span className="text-xs text-text-muted">Always here for you</span>
          </div>
        </div>
      </div>
      ...
      {/* Messages */}
      <div ref={scrollRef} className="flex-1 overflow-y-auto px-5 lg:px-8 py-4 space-y-4">
      ...
      <form onSubmit={handleSubmit} className="px-5 lg:px-8 pt-3 pb-4">
        ...
        <p className="text-[10px] text-text-muted text-center mt-2">
          MindSpace AI is here to support, not replace professional help. If you're in crisis, please reach out to a counselor.
        </p>
        </div>
      </form>
    </div>
